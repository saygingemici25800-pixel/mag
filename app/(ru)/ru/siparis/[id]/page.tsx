...
export const metadata = pageMetadata({ locale: "ru", path: "/siparis", title: t.track.metaTitle, noIndex: true });

export default async function TrackPageRu({ params }: PageProps<"/ru/siparis/[id]">) {
