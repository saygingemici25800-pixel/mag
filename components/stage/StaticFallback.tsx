  ...
  return (
    <main className="mx-auto max-w-5xl px-5 pt-28 pb-24 text-cream">
      ...
      <section className="mt-24 grid gap-8 sm:grid-cols-2">
        {t.claims.map((c) => (
          <article key={c.l1} className="flex flex-col gap-2">
            <span className="font-mono text-[.6rem] uppercase tracking-[.1em] line-through text-dim">{c.no}</span>
            <h2 className="font-display text-3xl font-black italic uppercase leading-[.85] tracking-tight">
              {c.l1} {c.l2}
            </h2>
      ...
      <section className="mt-24">
        <h2 className="font-display text-4xl font-black italic uppercase leading-[.85] tracking-tight">
      ...
      <footer className="mt-24 flex flex-col items-center gap-4 text-center">
        ...
        <p className="font-mono text-[.6rem] uppercase tracking-[.14em] text-dim">{t.footer.copy}</p>
        <nav className="flex gap-6 font-mono text-[.62rem] uppercase tracking-[.16em] text-dim">
