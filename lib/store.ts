...
import { FileOrderStore, FileReportStore, FileSettingsStore } from "@/lib/orders-store";
import { SupabaseOrderStore, SupabaseReportStore, SupabaseSettingsStore } from "@/lib/supabase-store";

const g = globalThis as unknown as { __magOrderStore?: OrderStore; __magSettingsStore?: SettingsStore; __magReportStore?: ReportStore; __magStoreMode?: "supabase" | "stub" };
